...
import { ChevronRight, Cpu, PanelLeft, LogOut } from 'lucide-react';
          ...
          >
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-3">
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-red-500/30 to-red-600/10 border border-red-500/20 text-sm font-black text-red-300 uppercase">
                  {user?.name?.[0] || 'A'}
                </div>
