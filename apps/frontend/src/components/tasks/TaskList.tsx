  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center py-14 px-6 text-center">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-red-500/20 bg-red-500/[0.05] mb-4">
          <AlertTriangle className="h-6 w-6 text-red-400" />
        </div>
        <h3 className="text-[14px] font-semibold text-white">Failed to load tasks</h3>
        <p className="mt-1 text-[12px] text-zinc-500">Could not reach the backend. Check your connection.</p>
        <button
          onClick={() => refetch()}
