...
/* Cinematic WebGL hero backdrop — client-only, never SSR'd */
const NeuralBrainCanvas = dynamic(
  () => import('@/components/hero/NeuralBrainCanvas'),
  { ssr: false },
);
...
<<<<<<< HEAD
      ...
      {/* ===================================================== */}
      <div className="pointer-events-none fixed inset-0 -z-20 overflow-hidden bg-[#040102]">
        {/* drifting 0/1 binary-code background — runs the full scroll, not just the hero */}
        <BinaryCodeBackdrop className="opacity-25" />
      </div>
...
<<<<<<< HEAD
        ...
        {/* subtle grid pattern overlay, faded out toward the edges */}
        <div
        ...
        {/* dark radial mask — lighter at centre so the brain shows through */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(4,1,2,0.65)_0%,rgba(4,1,2,0.25)_45%,rgba(4,1,2,0.85)_100%)]" />

        {/* top ambient ember glow */}
        <div className="absolute top-0 left-0 h-2/5 w-full bg-gradient-to-b from-[#ff3c0010] via-transparent to-transparent blur-3xl" />
...
>>>>>>> dab0d299b342a0e08b58cf73f14bd0e9670f5835
      ...
      <header
        className={cn(
          'fixed top-0 left-0 right-0 w-full z-50 bg-transparent transition-all duration-300',
      ...
      {/* HERO */}
      {/* ===================================================== */}
      <section className="relative flex min-h-[100vh] flex-col items-center justify-center px-6 py-32 text-center">
        {/* content sits above the page-level neural backdrop */}
