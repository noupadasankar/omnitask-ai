...
export class SocialDomainAgent extends BaseDomainAgent {
  ...
  readonly description = 'Generate, schedule, and automate social media posts across platforms like LinkedIn and Twitter';
  readonly taskTypes = ['social_post', 'social_schedule', 'social_analytics'];
