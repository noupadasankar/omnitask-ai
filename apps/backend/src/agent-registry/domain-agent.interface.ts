...
export interface DomainAgent {
  ...
  /**
   * Execute graph (delegates to runtime worker in practice).
   * Reserved for future in-process or clustered execution.
   */
  execute?(graph: ExecutionGraph, plan: AgentPlan): Promise<void>;
}
