...
// Handles agent step/plan-level safety: SSRF, blocked domains, dangerous actions, blocked JS.
// User-tier compliance (GDPR, PCI, rate limits) lives in common/policy/policy.service.ts.
